...
// C:/Users/Ronit/AppData/Roaming/npm/node_modules/wrangler/wrangler-dist/ProxyServerWorker.js
...
var ErrorStubHook = class extends StubHook {
  ...
  map(_path, _captures, _instructions) {
    return this;
  }
  get(_path) {
    return this;
...
var PROXY_HANDLERS = {
  ...
  getOwnPropertyDescriptor(_target, _p) {
    return void 0;
  },
...
var RpcPayload = class _RpcPayload {
  ...
  getHookForWritableStream(stream, _parent, dupStubs = true) {
    if (this.source === "params") {
  ...
  getHookForReadableStream(stream, _parent, dupStubs = true) {
    if (this.source === "params") {
...
var RpcSessionImpl = class {
  ...
  constructor(transport, mainHook, options) {
    ...
    let rejectFunc;
    let abortPromise = new Promise((_resolve, reject) => {
      rejectFunc = reject;
    });
  ...
  getStats() {
    ...
    for (let _i in this.imports) {
      ++result.imports;
    }
    for (let _i in this.exports) {
      ++result.exports;
    }
    return result;
  }
...
var WritableStreamStubHook = class _WritableStreamStubHook extends StubHook {
  ...
  map(_path, captures, _instructions) {
    for (let cap of captures) {
      cap.dispose();
    }
...
// .wrangler/tmp/bundle-5wWYK4/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-5wWYK4/middleware-loader.entry.ts
