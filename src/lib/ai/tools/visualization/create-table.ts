...
export const createTableTool = createTool({
  ...
  inputSchema: z.object({
    title: z.string().describe("The mandatory title of the table."),
    description: z
      .string()
      .nullable()
      .optional()
    ...
    columns: z
      .array(
        z.object({
          ...
          label: z.string().describe("Display name for the column header."),
          type: z
      ...
      .min(1)
      .describe(
        "Array of column definitions. At least one column is required.",
      ),
    data: z
      .array(z.record(z.string(), z.any()))
      .min(1, "At least 1 data row is required to create a table.")
      .describe(
        "Array of row data objects. Each object must contain keys matching the column definitions.",
      ),
  }),
  execute: async () => {
    return "Success";
