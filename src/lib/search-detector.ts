...
const EXTERNAL_TOPIC_KEYWORDS = [
  // Real-time data
  "price", "stock", "crypto", "btc", "eth", "bitcoin", "ethereum",
  "weather", "temperature", "forecast",
  "news", "breaking", "trending", "latest", "recent",
  "sports", "game", "match", "score", "result",
  "current", "today", "this week", "this month", "this year",
  
  // Specific entities/people/places
  "elon musk", "trump", "biden", "openai", "google", "meta",
  "new york", "london", "paris", "tokyo", "india",
  "2024", "2025",
];

// Keywords that indicate the query is about the AI itself (NOT a search)
const SELF_REFERENTIAL_KEYWORDS = [
  "you", "yourself", "your", "your name", "who are you",
  "what are you", "can you", "can you help", "help me",
