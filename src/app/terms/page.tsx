    ...
    <div className="container max-w-4xl py-12 px-4 mx-auto">
      ...
      <div className="prose dark:prose-invert max-w-none space-y-8">
        ...
        <section>
          ...
          <p>
            Wasp AI is a multi-model AI platform providing access to various
            Large Language Models (LLMs), image generation tools, and utility
            features. You understand and agree that the Service is provided
            &quot;AS-IS&quot; and that Wasp AI assumes no responsibility for the
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-2 mt-2">
            <li>
              ...
              harassing, defamatory, vulgar, obscene, or libellous.
            </li>
            <li>
              Generate content that promotes discrimination, hatred, or
              violence.
            </li>
        ...
        <section>
          ...
          <p>
            You acknowledge that the output provided by our AI models is
            generated by artificial intelligence. We make no guarantees
            regarding the accuracy, currency, or quality of any AI-generated
            content. You are solely responsible for how you use the generated
            content.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            The Wasp AI interface, logo, and proprietary code are the
            intellectual property of Wasp AI Solutions. Content you generate
            using the platform belongs to you, subject to the terms of the
            underlying model providers (e.g., OpenAI, Google, Anthropic).
          </p>
        </section>
