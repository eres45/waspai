...
export const metadata: Metadata = {
  ...
  description:
    "Learn more about WASPAI, our mission, and the team behind the next generation of AI automation.",
};
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-24 text-center">
            <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-8">
              ...
              <span className="text-white/40 italic">AI Autonomy.</span>
            </h1>
            <p className="text-xl text-white/40 leading-relaxed max-w-2xl mx-auto">
              WASPAI is 2026&apos;s leading multi-model AI platform, designed to
              empower developers and creatives with seamless access to
          ...
          <section className="p-12 rounded-[2rem] border border-white/10 bg-gradient-to-b from-white/[0.05] to-transparent mb-32">
            <h2 className="text-2xl font-bold mb-8 text-center uppercase tracking-widest">
              Legal Ownership & Identity
            </h2>
            <div className="space-y-6 text-center max-w-2xl mx-auto">
              <p className="text-lg text-white/60 italic leading-relaxed">
                &quot;WASPAI is more than just a tool; it&apos;s a commitment to
                making advanced intelligence accessible to everyone with minimal
                friction.&quot;
              </p>
              ...
              <div className="mt-8 pt-8 border-t border-white/5 grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
                <div>
                  <h4 className="text-sm font-bold text-white uppercase mb-4 opacity-40">
                    Registered Portal
                  </h4>
          ...
          <section className="prose prose-invert max-w-none mb-32">
            ...
            <div className="text-white/50 space-y-6 text-lg leading-relaxed">
              ...
              <p>
                ...
                image generation, video creation, and high-level reasoning. Our
                platform is managed with a focus on reliability, performance,
                and the developer-first aesthetic.
              </p>
            </div>
          </section>
