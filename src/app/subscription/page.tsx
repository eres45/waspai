    ...
    },
    {
      ...
      features: [
        ...
        },
        {
          ...
          items: [
            "~50 Pro image generations/day",
            "Unlimited file uploads",
            "Unlimited tool uses (Search, Code)",
            "Unlimited custom characters",
            "Private Agents & Workflows",
      ...
      features: [
        {
          ...
          items: [
            "GPT-5 (Pro), Claude 4.5 Opus/Sonnet",
            "Gemini 3 Pro, Grok 3, DeepSeek R1",
            "Reasoning Models (o1, o3, R1)",
            "All Free & Pro models (Highest limits)",
          ],
        },
        {
          category: "Ultra Studio",
          items: [
            "~200 Ultra image generations/day",
            "Video Generation Access",
            "Music Generation (Suno/Stable)",
            "Unlimited Real-time Voice Mode",
            "4K Image Upscaling",
        ...
        {
          category: "Support",
          items: ["Priority Live Chat", "Early Access to Beta"],
        },
      ],
