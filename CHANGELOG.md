...
* Add Azure OpenAI provider support with comprehensive testing ([#189](https://github.com/eres45/waspai/issues/189)) ([edad917](https://github.com/eres45/waspai/commit/edad91707d49fcb5d3bd244a77fbaae86527742a))
* add bot name preference to user settings ([f4aa588](https://github.com/eres45/waspai/commit/f4aa5885d0be06cc21149d09e604c781e551ec4a))
...
* add chat-related translations and enhance UI components with animations and improved accessibility ([c254c84](https://github.com/eres45/waspai/commit/c254c8472f6b59a9d79a84cae892a77bcc8aefcb))
* add common UI translations and enhance project and thread management components with improved localization ([bf05c55](https://github.com/eres45/waspai/commit/bf05c55cd9c5878d86fac079a8856bfe257e479e))
...
* add husky ([067d58d](https://github.com/eres45/waspai/commit/067d58dbbb58428bace3a71769c5a7dcea86bcd5))
* add husky for formatting and checking commits  ([#71](https://github.com/eres45/waspai/issues/71)) ([a379cd3](https://github.com/eres45/waspai/commit/a379cd3e869b5caab5bcaf3b03f5607021f988ef))
...
* Add js-execution tool and  bug fixes(tool call) ([#148](https://github.com/eres45/waspai/issues/148)) ([12b18a1](https://github.com/eres45/waspai/commit/12b18a1cf31a17e565eddc05764b5bd2d0b0edee))
...
* add language translation guidelines and instructions for contributing new languages to the chatbot ([3bb8fd3](https://github.com/eres45/waspai/commit/3bb8fd3d332e4bf65d87b8ca8b92c190500f308b))
* add LaTeX/TeX math equation rendering support ([#318](https://github.com/eres45/waspai/issues/318)) ([c0a8b5b](https://github.com/eres45/waspai/commit/c0a8b5b9b28599716013c83cac03fa5745ffd403))
* add lint-staged and remove commitlint ([67988b8](https://github.com/eres45/waspai/commit/67988b8ad29fba4fc4bfee93bf9fe2e9d83b7dc0))
* add logging for base URL configuration in auth server and update baseURL assignment for better clarity ([6ca13fd](https://github.com/eres45/waspai/commit/6ca13fdc8626c054b67c93f1a0c8994d413be411))
* add new translations for project and chat management, enhance sidebar components with improved UI interactions, and implement dynamic project and chat visibility toggles ([5319d9c](https://github.com/eres45/waspai/commit/5319d9c9764467cc74b08a4cc8d7a60fb384bad2))
* add new translations for reporting issues and joining the community, remove unused language selection component, and enhance theme selection functionality in the sidebar ([314973c](https://github.com/eres45/waspai/commit/314973ca033ce5c5bf9fc978c5fe74094faaa6e0))
* add openAI compatible provider support ([#92](https://github.com/eres45/waspai/issues/92)) ([6682c9a](https://github.com/eres45/waspai/commit/6682c9a320aff9d91912489661d27ae9bb0f4440))
...
* add Python execution tool and integrate Pyodide support ([#176](https://github.com/eres45/waspai/issues/176)) ([de2cf7b](https://github.com/eres45/waspai/commit/de2cf7b66444fe64791ed142216277a5f2cdc551))
* add qwen3 coder to models file for openrouter ([#206](https://github.com/eres45/waspai/issues/206)) ([3731d00](https://github.com/eres45/waspai/commit/3731d007100ac36a814704f8bde8398ce1378a4e))
...
* add sequential thinking tool and enhance UI components ([230f4a7](https://github.com/eres45/waspai/commit/230f4a7cd94fa88052069231e7bb6a5c9a18ff6e))
* add sequential thinking tool and enhance UI components ([#183](https://github.com/eres45/waspai/issues/183)) ([5bcbde2](https://github.com/eres45/waspai/commit/5bcbde2de776b17c3cc1f47f4968b13e22fc65b2))
...
* add Spanish, French, Japanese, and Chinese language support with UI improvements ([#74](https://github.com/eres45/waspai/issues/74)) ([e34d43d](https://github.com/eres45/waspai/commit/e34d43df78767518f0379a434f8ffb1808b17e17))
...
* Add support for Streamable HTTP Transport [#56](https://github.com/eres45/waspai/issues/56) ([#64](https://github.com/eres45/waspai/issues/64)) ([8783943](https://github.com/eres45/waspai/commit/878394337e3b490ec2d17bcc302f38c695108d73))
* Add web search and content extraction tools using Tavily API ([#126](https://github.com/eres45/waspai/issues/126)) ([f7b4ea5](https://github.com/eres45/waspai/commit/f7b4ea5828b33756a83dd881b9afa825796bf69f))
* admin and roles ([#270](https://github.com/eres45/waspai/issues/270)) ([63bddca](https://github.com/eres45/waspai/commit/63bddcaa4bc62bc85204a0982a06f2bed09fc5f5))
* agent sharing ([#226](https://github.com/eres45/waspai/issues/226)) ([090dd8f](https://github.com/eres45/waspai/commit/090dd8f4bf4fb82beb2cd9bfa0b427425bbbf352))
* **agent:** agent and archive  ([#192](https://github.com/eres45/waspai/issues/192)) ([c63ae17](https://github.com/eres45/waspai/commit/c63ae179363b66bfa4f4b5524bdf27b71166c299))
* ai v5 ([#230](https://github.com/eres45/waspai/issues/230)) ([0461879](https://github.com/eres45/waspai/commit/0461879740860055a278c96656328367980fa533))
* **chat:** enable [@mention](https://github.com/mention) and tool click to trigger workflow execution in chat ([#122](https://github.com/eres45/waspai/issues/122)) ([b4e7f02](https://github.com/eres45/waspai/commit/b4e7f022fa155ef70be2aee9228a4d1d2643bf10))
* credit contributors in releases and changlogs ([#104](https://github.com/eres45/waspai/issues/104)) ([e0e4443](https://github.com/eres45/waspai/commit/e0e444382209a36f03b6e898f26ebd805032c306))
* enhance authentication UI and add Korean translations ([1389e0a](https://github.com/eres45/waspai/commit/1389e0ab1e8e639cfa6f248001ffa2d9c13f6c47))
* enhance localization by adding new translations for chat, project, and keyboard shortcuts, and improve UI components with dynamic text rendering ([d71997d](https://github.com/eres45/waspai/commit/d71997dad6d685fa10099dd2e80d3e83aa403ecf))
* enhance MCPClient transport handling with StreamableHTTPClientTransport and fallback to SSE ([c3413c3](https://github.com/eres45/waspai/commit/c3413c3b6aa23e933bf27184c01aaf9a6c9bc333))
* enhance PromptInput with new Lightbulb icon and tooltip for Think Mode ([1bf3ad7](https://github.com/eres45/waspai/commit/1bf3ad71e40cf395c531a6526d4dc308881462c5))
* enhance TemporaryChat component with improved shortcut key display and update AppHeader to remove GitHub link, streamline UI interactions in AppSidebarUser for reporting issues and joining community ([5cb31b5](https://github.com/eres45/waspai/commit/5cb31b541ad55d19d216028c920202aa4900ec4a))
* enhance TemporaryChat component with new instructions feature, add corresponding translations, and improve UI interactions in AppHeader for better user experience ([0c7be80](https://github.com/eres45/waspai/commit/0c7be8052e815a43dad4ea81da27beb4f84668c3))
* export chat thread ([#278](https://github.com/eres45/waspai/issues/278)) ([23e79cd](https://github.com/eres45/waspai/commit/23e79cd570c24bab0abc496eca639bfffcb6060b))
* **file-storage:** image uploads, generate profile with ai ([#257](https://github.com/eres45/waspai/issues/257)) ([46eb43f](https://github.com/eres45/waspai/commit/46eb43f84792d48c450f3853b48b24419f67c7a1))
* generate image Tool (Nano Banana) ([#284](https://github.com/eres45/waspai/issues/284)) ([984ce66](https://github.com/eres45/waspai/commit/984ce665ceef7225870f4eb751afaf65bf8a2dd4))
* groq provider ([#268](https://github.com/eres45/waspai/issues/268)) ([aef213d](https://github.com/eres45/waspai/commit/aef213d2f9dd0255996cc4184b03425db243cd7b))
* hide LLM providers without API keys in model selection ([#269](https://github.com/eres45/waspai/issues/269)) ([63c15dd](https://github.com/eres45/waspai/commit/63c15dd386ea99b8fa56f7b6cb1e58e5779b525d))
* implement cold start-like auto connection for MCP server and simplify status ([#73](https://github.com/eres45/waspai/issues/73)) ([987c442](https://github.com/eres45/waspai/commit/987c4425504d6772e0aefe08b4e1911e4cb285c1))
* implement language selection component and enhance authentication UI with improved translations and user prompts ([d97d891](https://github.com/eres45/waspai/commit/d97d891bc3d63b4a9ca0df829177e0368bc4a462))
* implement sequential thinking mode in chat API and UI components ([8f4d945](https://github.com/eres45/waspai/commit/8f4d9452a73902455d362a3d2ff943e4b5757063))
* implement speech system prompt and update voice chat options for enhanced user interaction ([5a33626](https://github.com/eres45/waspai/commit/5a336260899ab542407c3c26925a147c1a9bba11))
...
* Implementation of PWA for much better UI on mobile  ([#252](https://github.com/eres45/waspai/issues/252)) ([51e6eab](https://github.com/eres45/waspai/commit/51e6eabcc34e1238a7536b5fffa433ba4ae4827a))
* improve authentication configuration and social login handling  ([#211](https://github.com/eres45/waspai/issues/211)) ([cd25937](https://github.com/eres45/waspai/commit/cd25937020710138ab82458e70ea7f6cabfd03ca))
* improve markdown table styling ([#244](https://github.com/eres45/waspai/issues/244)) ([7338e04](https://github.com/eres45/waspai/commit/7338e046196f72a7cc8ec7903593d94ecabcc05e))
* introduce changesets for version management and fix OpenAI voice chat options bug ([#63](https://github.com/eres45/waspai/issues/63)) ([9ae823b](https://github.com/eres45/waspai/commit/9ae823b602f1ee20a9b9aeb9e3a88537084033b1))
* introduce interactive table creation and enhance visualization tools ([#205](https://github.com/eres45/waspai/issues/205)) ([623a736](https://github.com/eres45/waspai/commit/623a736f6895b8737acaa06811088be2dc1d0b3c))
* Lazy Chat Title Generation: Save Empty Title First, Then Generate and Upsert in Parallel ([#162](https://github.com/eres45/waspai/issues/162)) ([31dfd78](https://github.com/eres45/waspai/commit/31dfd7802e33d8d4e91aae321c3d16a07fe42552))
* **mcp:** oauth ([#208](https://github.com/eres45/waspai/issues/208)) ([136aded](https://github.com/eres45/waspai/commit/136aded6de716367380ff64c2452d1b4afe4aa7f))
...
* openai image generate ([#287](https://github.com/eres45/waspai/issues/287)) ([0deef6e](https://github.com/eres45/waspai/commit/0deef6e8a83196afb1f44444ab2f13415de20e73))
* Per User Custom instructions ([#86](https://github.com/eres45/waspai/issues/86)) ([d45c968](https://github.com/eres45/waspai/commit/d45c9684adfb0d9b163c83f3bb63310eef572279))
* publish container to GitHub registry ([#149](https://github.com/eres45/waspai/issues/149)) ([9f03cbc](https://github.com/eres45/waspai/commit/9f03cbc1d2890746f14919ebaad60f773b0a333d))
* refactor chat preferences and shortcuts handling by replacing ShortcutsProvider with AppPopupProvider, update state management for temporary chat, and enhance keyboard shortcut functionality in related components ([84070d5](https://github.com/eres45/waspai/commit/84070d5d31922a85ab2f322216d5c79da0dc2f74))
* **releases:** add debug logging to the add authors and update release step ([#105](https://github.com/eres45/waspai/issues/105)) ([c855a6a](https://github.com/eres45/waspai/commit/c855a6a94c49dfd93c9a8d1d0932aeda36bd6c7e))
* remove experimental caching option from Next.js config, add deepmerge dependency, and enhance message handling in i18n request for improved localization ([c1d3e3b](https://github.com/eres45/waspai/commit/c1d3e3b1501ebdac2b2c7f169ddc33cf95f3d6f4))
* s3 storage and richer file support ([#301](https://github.com/eres45/waspai/issues/301)) ([051a974](https://github.com/eres45/waspai/commit/051a9740a6ecf774bfead9ce327c376ea5b279a5))
* set maxTokens to 30 in generateTitleFromUserMessageAction for improved title generation ([7dde3f1](https://github.com/eres45/waspai/commit/7dde3f156d60488488862967b40d81aa02a29955))
...
* start i18n ([a9457d5](https://github.com/eres45/waspai/commit/a9457d5d8933a43518a1e4c83114124aaa2dda2e))
...
* tsconfig.tsbuildinfo 디렉토리를 기본 정리 목록에 추가 ([62ab4d8](https://github.com/eres45/waspai/commit/62ab4d8d5df2e8047756d746c9d8e2b1ff8c09c4))
* update MCP server UI and translations for improved user experience ([1e2fd31](https://github.com/eres45/waspai/commit/1e2fd31f8804669fbcf55a4c54ccf0194a7e797c))
* update mention ux ([#161](https://github.com/eres45/waspai/issues/161)) ([7ceb9c6](https://github.com/eres45/waspai/commit/7ceb9c69c32de25d523a4d14623b25a34ffb3c9d))
* **voice-chat:** binding agent tools ([#275](https://github.com/eres45/waspai/issues/275)) ([ed45e82](https://github.com/eres45/waspai/commit/ed45e822eb36447f2a02ef3aa69eeec88009e357))
* web-search with images ([bea76b3](https://github.com/eres45/waspai/commit/bea76b3a544d4cf5584fa29e5c509b0aee1d4fee))
* **web-search:** replace Tavily API with Exa AI integration ([#204](https://github.com/eres45/waspai/issues/204)) ([7140487](https://github.com/eres45/waspai/commit/7140487dcdadb6c5cb6af08f92b06d42411f7168))
* workflow beta ([#100](https://github.com/eres45/waspai/issues/100)) ([2f5ada2](https://github.com/eres45/waspai/commit/2f5ada2a66e8e3cd249094be9d28983e4331d3a1))
* **workflow:** add auto layout feature for workflow nodes and update UI messages ([0cfbffd](https://github.com/eres45/waspai/commit/0cfbffd631c9ae5c6ed57d47ca5f34b9acbb257d))
* **workflow:** Add HTTP and Template nodes with LLM structured output supportWorkflow node ([#117](https://github.com/eres45/waspai/issues/117)) ([10ec438](https://github.com/eres45/waspai/commit/10ec438f13849f0745e7fab652cdd7cef8e97ab6))
* **workflow:** add HTTP node configuration and execution support ([7d2f65f](https://github.com/eres45/waspai/commit/7d2f65fe4f0fdaae58ca2a69abb04abee3111c60))
* **workflow:** stable workflow  ( add example workflow : baby-research ) ([#137](https://github.com/eres45/waspai/issues/137)) ([c38a7ea](https://github.com/eres45/waspai/commit/c38a7ea748cdb117a4d0f4b886e3d8257a135956))


### Bug Fixes

* .next 디렉토리 정리 명령어 제거 ([3387ed5](https://github.com/eres45/waspai/commit/3387ed51cf24b125a9039147bf14d513d0e9c2bc))
* [#111](https://github.com/eres45/waspai/issues/111)  prevent MCP server disconnection during long-running tool calls ([#238](https://github.com/eres45/waspai/issues/238)) ([b5bb3dc](https://github.com/eres45/waspai/commit/b5bb3dc40a025648ecd78f547e0e1a2edd8681ca))
* Add .next cleanup to postinstall and fix db-migrate exit handling ([#272](https://github.com/eres45/waspai/issues/272)) ([15ff34d](https://github.com/eres45/waspai/commit/15ff34d6a8a4c2c968ff08f9dcd6d87b7c85f652))
...
* add cache-busting to favicon URLs to force browser refresh ([8aba289](https://github.com/eres45/waspai/commit/8aba28953897586453c881f9f449fae0e2c61e5a))
...
* add error handling for missing POSTGRES_URL environment variable ([06c0b25](https://github.com/eres45/waspai/commit/06c0b254011fc37366249cb062ea0b0c03bd93f3))
...
* add POST endpoint for MCP client saving with session validation ([fa005aa](https://github.com/eres45/waspai/commit/fa005aaecbf1f8d9279f5b4ce5ba85343e18202b))
...
* **agent:** improve agent loading logic and validation handling in EditAgent component [#198](https://github.com/eres45/waspai/issues/198) ([ec034ab](https://github.com/eres45/waspai/commit/ec034ab51dfc656d7378eca1e2b4dc94fbb67863))
* **agent:** update description field to allow nullish values in ChatMentionSchema ([3e4532d](https://github.com/eres45/waspai/commit/3e4532d4c7b561ad03836c743eefb7cd35fe9e74))
...
* **api:** handle error case in chat route by using orElse for unwrap ([25580a2](https://github.com/eres45/waspai/commit/25580a2a9f6c9fbc4abc29fee362dc4b4f27f9b4))
* Apply DISABLE_SIGN_UP to OAuth providers ([#282](https://github.com/eres45/waspai/issues/282)) ([bcc0db8](https://github.com/eres45/waspai/commit/bcc0db8eb81997e54e8904e64fc76229fbfc1338))
* bug(LineChart): series are incorrectly represented [#165](https://github.com/eres45/waspai/issues/165) ([4e4905c](https://github.com/eres45/waspai/commit/4e4905c0f7f6a3eca73ea2ac06f718fa29b0f821))
* clean changlelog and stop duplicate attributions in the changelog file ([#119](https://github.com/eres45/waspai/issues/119)) ([aa970b6](https://github.com/eres45/waspai/commit/aa970b6a2d39ac1f0ca22db761dd452e3c7a5542))
...
* create manifest route handler to serve valid JSON ([5ccb4d4](https://github.com/eres45/waspai/commit/5ccb4d4b0b93d40339085002429589f63c9f67d1))
...
* disable Better-Auth database adapter to remove PostgreSQL connection attempts ([e5249fe](https://github.com/eres45/waspai/commit/e5249fee38d1b4f8a52d34781a3065401810405e))
...
* Enhance component styles and configurations ([a7284f1](https://github.com/eres45/waspai/commit/a7284f12ca02ee29f7da4d57e4fe6e8c6ecb2dfc))
* enhance error handling in chat bot component ([1519799](https://github.com/eres45/waspai/commit/15197996ba1f175db002b06e3eac2765cfae1518))
* enhance event handling for keyboard shortcuts in chat components ([95dad3b](https://github.com/eres45/waspai/commit/95dad3bd1dac4b6e56be2df35957a849617ba056))
* enhance mobile UI experience with responsive design adjustments ([2eee8ba](https://github.com/eres45/waspai/commit/2eee8bab078207841f4d30ce7708885c7268302e))
* enhance ToolModeDropdown with tooltip updates and debounce functionality ([d06db0b](https://github.com/eres45/waspai/commit/d06db0b3e1db34dc4785eb31ebd888d7c2ae0d64))
...
* ensure PKCE works for MCP Server auth ([#256](https://github.com/eres45/waspai/issues/256)) ([09b938f](https://github.com/eres45/waspai/commit/09b938f17ca78993a1c7b84c5a702b95159542b2))
* ensure thread date fallback to current date in AppSidebarThreads component ([800b504](https://github.com/eres45/waspai/commit/800b50498576cfe1717da4385e2a496ac33ea0ad))
* escape apostrophes in JSX text ([2f43492](https://github.com/eres45/waspai/commit/2f43492bce8d06112b241e4563686056c6a73617))
* escape apostrophes in JSX text ([5c12b00](https://github.com/eres45/waspai/commit/5c12b001a321bd10083cd6999bcacf24c4725349))
* escape apostrophes in subscription popup ([507b3db](https://github.com/eres45/waspai/commit/507b3db4d37067b23316b77d878464ad77856658))
* exclude scripts folder from TypeScript compilation ([0e57764](https://github.com/eres45/waspai/commit/0e57764c8b6f014c65543fb305200621e96eddef))
...
* force runtime db execution for auth pages to avoid build-time connection errors ([2af0d6a](https://github.com/eres45/waspai/commit/2af0d6aaef8d61f92835843d46dfd1e22f08c178))
* generate title by user message ([9ee4be6](https://github.com/eres45/waspai/commit/9ee4be69c6b90f44134d110e90f9c3da5219c79f))
* generate title sync ([5f3afdc](https://github.com/eres45/waspai/commit/5f3afdc4cb7304460606b3480f54f513ef24940c))
* hide MCP server credentials from non-owners ([#317](https://github.com/eres45/waspai/issues/317)) ([#319](https://github.com/eres45/waspai/issues/319)) ([6e32417](https://github.com/eres45/waspai/commit/6e32417535c27f1215f96d68b7302dba4a1b904d))
* hsuky ([3dcde85](https://github.com/eres45/waspai/commit/3dcde858a365ee57fb67c518e61855485c34c6e3))
* **i18n:** update agent description fields in English, Spanish, and French JSON files to improve clarity and consistency ([f07d1c4](https://github.com/eres45/waspai/commit/f07d1c4dc64b96584faa7e558f981199834a5370))
* ignore tool binding on unsupported models (server-side) ([#160](https://github.com/eres45/waspai/issues/160)) ([277b4fe](https://github.com/eres45/waspai/commit/277b4fe986d5b6d9780d9ade83f294d8f34806f6))
* implement responsive horizontal layout for chat mention input with improved UX And generate Agent Prompt ([43ec980](https://github.com/eres45/waspai/commit/43ec98059e0d27ab819491518263df55fb1c9ad3))
...
* improve error display with better UX and animation handling ([#227](https://github.com/eres45/waspai/issues/227)) ([35d62e0](https://github.com/eres45/waspai/commit/35d62e05bb21760086c184511d8062444619696c))
* improve session error handling in authentication ([eb15b55](https://github.com/eres45/waspai/commit/eb15b550facf5368f990d58b4b521bf15aecbf72))
* increase maxTokens for title generation in chat actions issue  [#102](https://github.com/eres45/waspai/issues/102) ([bea2588](https://github.com/eres45/waspai/commit/bea2588e24cf649133e8ce5f3b6391265b604f06))
* Invalid 'tools': array too long. Expected an array with maximum length 128, but got an array with length 217 instead. [#197](https://github.com/eres45/waspai/issues/197) ([b967e3a](https://github.com/eres45/waspai/commit/b967e3a30be3a8a48f3801b916e26ac4d7dd50f4))
* js executor tool and gemini model version ([#169](https://github.com/eres45/waspai/issues/169)) ([e25e10a](https://github.com/eres45/waspai/commit/e25e10ab9fac4247774b0dee7e01d5f6a4b16191))
* lazy-initialize database connection to avoid build-time connection errors ([5ce5055](https://github.com/eres45/waspai/commit/5ce5055725123d29f6440302993c53afa985a704))
* lazy-initialize Supabase client with better error handling ([427854c](https://github.com/eres45/waspai/commit/427854c151ad7a4e82218c58fa0f466cbd4556e3))
* link to the config generator correctly ([#184](https://github.com/eres45/waspai/issues/184)) ([1865ecc](https://github.com/eres45/waspai/commit/1865ecc269e567838bc391a3236fcce82c213fc0))
...
* **mcp:** ensure database and memory manager sync across server instances ([#229](https://github.com/eres45/waspai/issues/229)) ([c4b8ebe](https://github.com/eres45/waspai/commit/c4b8ebe9566530986951671e36111a2e529bf592))
* **mcp:** fix MCP infinite loading issue ([#220](https://github.com/eres45/waspai/issues/220)) ([c25e351](https://github.com/eres45/waspai/commit/c25e3515867c76cc5494a67e79711e9343196078))
* **mcp:** Safe MCP manager init logic for the Vercel environment ([#202](https://github.com/eres45/waspai/issues/202)) ([708fdfc](https://github.com/eres45/waspai/commit/708fdfcfed70299044a90773d3c9a76c9a139f2f))
...
* model name for gpt-4.1-mini in staticModels ([#299](https://github.com/eres45/waspai/issues/299)) ([4513ac0](https://github.com/eres45/waspai/commit/4513ac0e842f588a24d7075af8700e3cc7a3eb39))
* move display names to separate utility file ([90f68f5](https://github.com/eres45/waspai/commit/90f68f53fa3219689105dd9a24be56a3c9b76d5f))
...
* ollama disable issue ([#283](https://github.com/eres45/waspai/issues/283)) ([5e0a690](https://github.com/eres45/waspai/commit/5e0a690bb6c3f074680d13e09165ca9fff139f93))
...
* python executor ([ea58742](https://github.com/eres45/waspai/commit/ea58742cccd5490844b3139a37171b1b68046f85))
...
* refine thinking prompt condition in chat API ([0192151](https://github.com/eres45/waspai/commit/0192151fec1e33f3b7bc1f08b0a9582d66650ef0))
...
* remove favicon.ico route handler to serve static file directly ([01c051c](https://github.com/eres45/waspai/commit/01c051c7c4d6cd9b2b1913a40a2d74e7c6863ecb))
* remove file to get file types for lint-staged ([0c1e7eb](https://github.com/eres45/waspai/commit/0c1e7eb0ba74c8b9222f4981b7d38bae41df1a17))
* remove manifest reference from layout since Next.js auto-generates it ([7bf1758](https://github.com/eres45/waspai/commit/7bf1758854da8859230189b4464111743e5a645c))
* remove old favicon files and update icon references with new cache-buster ([5173874](https://github.com/eres45/waspai/commit/5173874b35c207cd96e9787ba86fa9505f54a06d))
* remove unnecessary || undefined check on metadata object ([4cbf529](https://github.com/eres45/waspai/commit/4cbf529b5b0ffc5aa4554623310daff6931b384d))
* remove unused cn import ([d70ff1b](https://github.com/eres45/waspai/commit/d70ff1be7409af640c67fa5fe130b78352cae203))
* remove unused cn import from upload-limit-badge ([bcb1a1b](https://github.com/eres45/waspai/commit/bcb1a1bfda6c372424856843f8f6547afea4dacc))
* remove unused DEFAULT_VOICE_TOOLS and ToolUIPart imports ([896329a](https://github.com/eres45/waspai/commit/896329a618fbd3cc0955c68366c50451edc0a358))
* remove unused imports and functions from image tools ([59cfd16](https://github.com/eres45/waspai/commit/59cfd165afa51d2164ca802b7be317b112b6eeef))
* remove unused KIWI_AI_SYSTEM_PROMPT import ([3225735](https://github.com/eres45/waspai/commit/322573526ab0276ea7d99ef9f644a34e6da53005))
* remove unused selectedPlan state and useState import ([84622b3](https://github.com/eres45/waspai/commit/84622b351f8c5383f957fec94000b1fd65e203e8))
* remove unused selectedPrivacy state ([7c25d32](https://github.com/eres45/waspai/commit/7c25d32b750bab0552fc97e9f460b46f36f0aaf2))
* remove unused storeThreadId variable ([17f4efe](https://github.com/eres45/waspai/commit/17f4efef7ba3376d26e56c9766552426bdef0af9))
* remove unused ToolResultPart import ([8596e68](https://github.com/eres45/waspai/commit/8596e68357d5601d4a95af842c52c460348f541b))
* remove unused ToolResultPart import from video-gen ([4a98834](https://github.com/eres45/waspai/commit/4a98834962d1d80cd2515f2c460f4ec84c9b80c9))
...
* remove unused X icon import ([52850f8](https://github.com/eres45/waspai/commit/52850f8a5720ff8ea918571ba22f5b3298a7d034))
...
* resolve ESLint errors for Vercel build ([828213b](https://github.com/eres45/waspai/commit/828213b3ce47dbfd0006ec6aaf6c42fb941331c4))
...
* safely access description property on union type ([a3c8d58](https://github.com/eres45/waspai/commit/a3c8d58bdda3e2f799ba80df3c35023b35e80855))
* **scripts:** parse openai compatible on windows ([#164](https://github.com/eres45/waspai/issues/164)) ([41f5ff5](https://github.com/eres45/waspai/commit/41f5ff55b8d17c76a23a2abf4a6e4cb0c4d95dc5))
...
* skip database migration during Vercel build ([e234db1](https://github.com/eres45/waspai/commit/e234db1548a389545091c4a02fcb56ca7a956571))
* speech ux ([baa849f](https://github.com/eres45/waspai/commit/baa849ff2b6b147ec685c6847834385652fc3191))
* split theme system into base themes and style variants ([61ebd07](https://github.com/eres45/waspai/commit/61ebd0745bcfd7a84ba3ad65c3f52b7050b5131a))
* support OpenAI real-time chat project instructions ([2ebbb5e](https://github.com/eres45/waspai/commit/2ebbb5e68105ef6706340a6cfbcf10b4d481274a))
* temporary chat initial model ([0393f7a](https://github.com/eres45/waspai/commit/0393f7a190463faf58cbfbca1c21d349a9ff05dc))
* tool select ui ([#141](https://github.com/eres45/waspai/issues/141)) ([0795524](https://github.com/eres45/waspai/commit/0795524991a7aa3e17990777ca75381e32eaa547))
...
* UI improvements for mobile experience ([#66](https://github.com/eres45/waspai/issues/66)) ([b4349ab](https://github.com/eres45/waspai/commit/b4349abf75de69f65a44735de2e0988c6d9d42d8))
* unify SSE and streamable config as RemoteConfig ([#85](https://github.com/eres45/waspai/issues/85)) ([66524a0](https://github.com/eres45/waspai/commit/66524a0398bd49230fcdec73130f1eb574e97477))
* update adding-openAI-like-providers.md ([#101](https://github.com/eres45/waspai/issues/101)) ([2bb94e7](https://github.com/eres45/waspai/commit/2bb94e7df63a105e33c1d51271751c7b89fead23))
* update config file path in release workflow ([7209cbe](https://github.com/eres45/waspai/commit/7209cbeb89bd65b14aee66a40ed1abb5c5f2e018))
...
* update import path for createReverseModelMapping ([e7913f5](https://github.com/eres45/waspai/commit/e7913f5f640776dd7fb7f501e1afa4e76e178fba))
* update import path in title route ([0690440](https://github.com/eres45/waspai/commit/0690440eef0e8a3f318962d5d22f038f1a2205fb))
* update lastThreadAt calculation in chat repository to handle null values by using COALESCE for better data integrity ([4a5489c](https://github.com/eres45/waspai/commit/4a5489c8cfacc3d84fb439725e0b3cd5f21469ac))
* update route handler params type for Next.js 15 ([c404435](https://github.com/eres45/waspai/commit/c4044356210b3963e29f9b1d5d73f65b4e3b80d0))
* update sign-out behavior to redirect to sign-in page instead of … ([#61](https://github.com/eres45/waspai/issues/61)) ([04f771a](https://github.com/eres45/waspai/commit/04f771aa0ee1c170438ba8c78dd377fb65cea05e))
* update sign-out behavior to redirect to sign-in page instead of reloading the window for improved user experience ([3001591](https://github.com/eres45/waspai/commit/30015915e9c53a047451bc1501148918f0a941b7))
* update StorageInfo type to include supabase and snapzion ([26cac8a](https://github.com/eres45/waspai/commit/26cac8aa287f2983ae3c80d1295c6f4662b80f77))
* update tool selection logic in McpServerSelector to maintain current selections ([4103c1b](https://github.com/eres45/waspai/commit/4103c1b828c3e5b513679a3fb9d72bd37301f99d))
* update ToolMessagePart to use isExecuting state instead of isExpanded ([752f8f0](https://github.com/eres45/waspai/commit/752f8f06e319119569e9ee7c04d621ab1c43ca54))
* update translation key in ErrorMessage component for improved lo… ([#60](https://github.com/eres45/waspai/issues/60)) ([463ea4b](https://github.com/eres45/waspai/commit/463ea4b1c129f6554737495dd17401f01f1aad0d))
* update translation key in ErrorMessage component for improved localization consistency ([789172b](https://github.com/eres45/waspai/commit/789172b341c5c0d3a68781f6ca89468ecba5742c))
...
* use favicon.ico with all standard sizes bundled ([61558f4](https://github.com/eres45/waspai/commit/61558f4d8d4748ed1c90e0f52c2cd23bd7f81ea8))
* use proper favicon.ico with all sizes ([30df964](https://github.com/eres45/waspai/commit/30df964c1a57cb8afd9dc8e46baffaf2a8bb7231))
* use static manifest.json from public directory with proper formatting ([edf5a6e](https://github.com/eres45/waspai/commit/edf5a6eada15d167beb70114d8892d4e9598e1f9))
* use Supabase HTTP client for auth queries to avoid IPv6 connection issues ([d9ae189](https://github.com/eres45/waspai/commit/d9ae189965d4f172fb22d5a25d6d73b1e8a1a83d))
...
* workflow condition node issue ([78b7add](https://github.com/eres45/waspai/commit/78b7addbba51b4553ec5d0ce8961bf90be5d649c))
* **workflow-panel:** fix save button width ([#168](https://github.com/eres45/waspai/issues/168)) ([3e66226](https://github.com/eres45/waspai/commit/3e6622630c9cc40ff3d4357e051c45f8c860fc10))
* **workflow:** enhance structured output handling and improve user notifications ([dd43de9](https://github.com/eres45/waspai/commit/dd43de99881d64ca0c557e29033e953bcd4adc0e))
* **workflow:** improve mention handling by ensuring empty values are represented correctly ([92ff9c3](https://github.com/eres45/waspai/commit/92ff9c3e14b97d9f58a22f9df2559e479f14537c))
* **workflow:** llm structure Output ([c529292](https://github.com/eres45/waspai/commit/c529292ddc1a4b836a5921e25103598afd7e3ab7))
* **workflow:** MPC Tool Response Structure  And Workflow  ([#113](https://github.com/eres45/waspai/issues/113)) ([836ffd7](https://github.com/eres45/waspai/commit/836ffd7ef5858210bdce44d18ca82a1c8f0fc87f))
* **workflow:** simplify mention formatting by removing bold styling for non-empty values ([ef65fd7](https://github.com/eres45/waspai/commit/ef65fd713ab59c7d8464cae480df7626daeff5cd))
...
* release 1.5.2 ([d185514](https://github.com/eres45/waspai/commit/d1855148cfa53ea99c9639f8856d0e7c58eca020))
